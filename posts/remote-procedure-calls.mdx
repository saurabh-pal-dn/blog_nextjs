...
This makes communication langrage-agnostic and the backend system can use different langues for different works.
...
1. A local call may return/throw/void, a network may timeout as well. If you don't get a response you cannot assume anything about the call execution.
